...
import it.prova.gestioneebay.web.dto.utente.UtenteDTO;
...
public class AdminExecuteModificaUtenteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int creditoResiduo = Integer.parseInt(request.getParameter("creditoInput"));
		
		UtenteDTO utenteDTO = new UtenteDTO(idUtente, nome, cognome, username, password, creditoResiduo);
		...
		utenteDaModificare.setCreditoResiduo(creditoResiduo);
