package it.prova.gestioneebay.web.filters;
...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] EXCLUDED_URLS = { "/DettaglioAnnuncioServlet", "/annuncio/dettaglio.jsp",
			"/resultAnnuncio.jsp", "/ExecuteSearchAnnuncioServlet", "/resultAnnuncio.jsp",
			"/PrepareSearchAnnuncioServlet", "/login.jsp", "/LoginServlet", "/LogoutServlet", "/css/", "/js/" };
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!isInWhiteList) {
			...
			if (isPathForOnlyAdministrators(pathAttuale) && !utenteInSession.isAdmin()) {
				...
				httpRequest.getRequestDispatcher("/PrepareSearchAnnuncio").forward(httpRequest, httpResponse);
				return;
			}
		}
