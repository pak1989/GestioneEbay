...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
			<h3>Creazione Nuovo Annuncio</h3>
		</div>

		<form class="form-horizontal"
			action="<%=request.getContextPath() + "/ExecuteInsertAnnuncioServlet"%>"
			method="post">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-primary btn-md">Pubblica</button>
