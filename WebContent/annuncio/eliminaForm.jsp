...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
			<h3>Eliminare annuncio?</h3>
		</div>
		
		<form class="form-horizontal"
			action="<%=request.getContextPath() + "/ExecuteEliminaAnnuncioServlet"%>"
			method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="testoAnnuncioId" readonly="readonly"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="prezzoInputId" readonly="readonly"
...
<%--    		 		<input type="checkbox" id="ruoliInputId" name="ruoliInput" value="${ruoliItem.id}"> ${ruoliItem.codice}<br> --%>
				...
				<input type="checkbox" id="categoryInputId"  readonly="readonly" name="categoryInput" value="${categoryItem.id}" ${checked?"checked='checked'":""}> ${categoryItem.nome} 
   		 	</c:forEach>
				</div>
			</div>
